...
There are three parts to this tutorial.  The first part is written is the jupyter notebooks name Kalman-Tutorial.ipynb.  This notebook is based on Dr. Michal van Biezen's multipart Youtube tutorial https://www.youtube.com/user/ilectureonline.  The notebook was meant to mirror his calculations of the basic linear Kalman Filter.  The same model is developed in C++ Kalman-Tutorial.cpp.  The cpp file can be compiled directly in GNU g++ Kalman-Tutoria.cpp -o Kalman-Tutorial and then run with ./Kalman-Tutorial.
